...
namespace Server_Creation_Tool.myClasses
{
    class global_Variables
    {
        ...
        public string days7InstCode = @"+login anonymous +force_install_dir ./7days_ds/ +app_update 294420 validate";
        ...
        public string arkInstCode = @"+login anonymous +force_install_dir ./ARK_ds/ +app_update 376030 validate";
        ...
        public string bo3InstCode = @"+login anonymous +force_install_dir ./bo3_ds/ +app_update 545990 validate";
        ...
        public string csInstCode = @"+login anonymous +force_install_dir ./cs_ds/ +app_update 90 validate";
        ...
        public string cssInstCode = @"+login anonymous +force_install_dir ./css_ds/ +app_update 232330 validate";
        ...
        public string csgoInstCode = @"+login anonymous +force_install_dir ./csgo_ds/ +app_update 740 validate";
        ...
        public string gmodInstCode = @"+login anonymous +force_install_dir ./gmod_ds/ +app_update 4020 validate";
        ...
        public string hurtworldInstCode = @"+login anonymous +force_install_dir ./hurtworld_ds/ +app_update 405100 validate";
        ...
        public string kf2InstCode = @"+login anonymous +force_install_dir ./kf2_ds/ +app_update 232130 validate";
        ...
        public string l4dInstCode = @"+login anonymous +force_install_dir ./l4d_ds/ +app_update 222840 validate";
        ...
        public string l4d2InstCode = @"+login anonymous +force_install_dir ./l4d2_ds/ +app_update 222860 validate";
        ...
        public string rustInstCode = @"+login anonymous +force_install_dir ./rust_ds/ +app_update 258550 validate";
        ...
        public string svenInstCode = @"+login anonymous +force_install_dir ./sven_ds/ +app_update 276060 validate";
        ...
        public string unturnedInstCode = @"+login anonymous +force_install_dir ./unturned_ds/ +app_update 1110390 validate";
        ...
        public string atlasInstCode = @"+login anonymous +force_install_dir ./atlas_ds/ +app_update 1110390 validate";
        ...
        public string craftopiaInstCode = @"+login anonymous +force_install_dir ./craftopia_ds/ +app_update 1670340 validate";
