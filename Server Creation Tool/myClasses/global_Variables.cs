...
namespace Server_Creation_Tool.myClasses
{
    class global_Variables
    {
        ...
        public string[] updateCheckingInfo = new string[] {
            ...
            "41" };//The version of this tool. Remove the comma.   e.g 3.2 is 32
        ...
        public string days7RootFold = "7daysserver";
        ...
        public string days7InstCode = @"+login anonymous +force_install_dir ./7daysserver/ +app_update 294420 validate";
        ...
        public string arkRootFold = "ARKds";
        ...
        public string arkInstCode = @"+login anonymous +force_install_dir ./ARKds/ +app_update 376030 validate";
        ...
        public string bo3RootFold = "bo3ds";
        ...
        public string bo3InstCode = @"+login anonymous +force_install_dir ./bo3ds/ +app_update 545990 validate";
        ...
        public string csInstCode = @"+login anonymous +force_install_dir ./csds/ +app_update 90 validate";
        ...
        public string cssRootFold = "cssds";
        ...
        public string cssInstCode = @"+login anonymous +force_install_dir ./cssds/ +app_update 232330 validate";
        ...
        public string csgoRootFold = "csgods";
        ...
        public string csgoInstCode = @"+login anonymous +force_install_dir ./csgods/ +app_update 740 validate";
        ...
        public string gmodRootFold = "gmodds";
        ...
        public string gmodInstCode = @"+login anonymous +force_install_dir ./gmodds/ +app_update 4020 validate";
        ...
        public string hurtworldRootFold = "hurtworldserver";
        ...
        public string hurtworldInstCode = @"+login anonymous +force_install_dir ./hurtworldserver/ +app_update 405100 validate";
        ...
        public string kf2RootFold = "kf2ds";
        ...
        public string kf2InstCode = @"+login anonymous +force_install_dir ./kf2ds/ +app_update 232130 validate";
        ...
        public string l4dRootFold = "l4dserver";
        ...
        public string l4dInstCode = @"+login anonymous +force_install_dir ./l4dserver/ +app_update 222840 validate";
        ...
        public string l4d2RootFold = "l4d2ds";
        ...
        public string l4d2InstCode = @"+login anonymous +force_install_dir ./l4d2ds/ +app_update 222860 validate";
        ...
        public string rustRootFold = "rustserver";
        ...
        public string rustInstCode = @"+login anonymous +force_install_dir ./rustserver/ +app_update 258550 validate";
        ...
        public string svenRootFold = "svends";
        ...
        public string svenInstCode = @"+login anonymous +force_install_dir ./svends/ +app_update 276060 validate";
        ...
        public string unturnedRootFold = "unturnedserver";
        ...
        public string beamngRootFold = "beamngserver";
        ...
        public string craftopiaRootFold = "craftopiads";
        ...
        public string craftopiaInstCode = @"+login anonymous +force_install_dir ./craftopiads/ +app_update 1670340 validate";
