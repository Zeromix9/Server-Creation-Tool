    ...
    public partial class MainForm : Form
    {
...

        {
            ...
            try
            {
                if (steamCmdSpeicherort != null)
                {
                    ...
                    {
                        MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Ark: Survival Evolved Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        void Button3Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Counter Strike Source Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button4Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Counter Strike Global Offensive Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button5Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Counter Strike 1.6 Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button6Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Garry's Mod Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button8Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Killing Floor 2 Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button10Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Left 4 dead 2 Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button11Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Seven Coop Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        void Button12Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Rust Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        //DIS IS NOT WORKING.SYNERGY SERVER UNDER CONSTRUCTION
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Synergy Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        {
            MessageBox.Show("13.05.2019 - Version 2.6 - Added Left4dead, also the interface was updated and an update system was implemented" +
                            Environment.NewLine +
                            Environment.NewLine +
                            "03.03.2019 - Version 2.5 - Enabled Counter-Strike 1.6 again" +
                            Environment.NewLine +
                            Environment.NewLine +
                            ...
                            "19.07.2016 - Version 1.1 - Added Garry´s Mod Guides" +
                             Environment.NewLine +
                             Environment.NewLine +
                            "27.06.2016 - Version 1.0 - Release", "Changelog");
        }
        ...
        void FAQToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            Environment.NewLine +
            "You can do this in the linked Group.", "FAQ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        void Button18Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found!Please select its location again", "Install Call Of Duty Black Ops 3 Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("An update is available! Do you want to download it?", "Download Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
        ...
        private void button7_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("SteamCMD could not be found! Please select its location again", "Install Left 4 dead Server", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    groupBox1.Enabled = false;
                    locateSteamCMDBtn.Text = "      Locate SteamCMD";
                    locateSteamCMDBtn.ForeColor = Color.Red;
                    locateSteamCMDBtn.Image = Properties.Resources.icons8_delete_24;
