...
namespace Server_Creation_Tool.myClasses
{
    class global_Variables
    {
        ...
        public string[] unturnedGuideLink = new string[] { "https://unturned.fandom.com/wiki/Hosting_a_Dedicated_Server#Configuring_your_Server:" };
        ...
        public string[] beamngAdvSrvManageLink = new string[] { @"https://api.github.com/repos/SteliosLL/BeamMP-Server-Management-Tool/releases/latest" , "https://github.com/SteliosLL/BeamMP-Server-Management-Tool/releases/tag/v2.1.1" }; //first link is API and second one is regular 
        //----ATLAS----
        ...
        public string[] nmrihCfgFilelink = new string[] { "https://pastebin.com/raw/ftgK39mV", "https://pastebin.com/biKHhYu0" };
